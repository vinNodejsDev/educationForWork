...
const Authentication = props => {
  ...
  const handleSubmit = (e) => {
    ...
    doFetch({
      ...
      data: {
        user: {
          email: 'sfsdfsd@dssd.sd',
          password: 'dsfsdfsd3fwe'
        }
      }
    })
